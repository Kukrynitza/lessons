...
function checkboxIventRocket(event){
  ...
  if (completed ==='false') {
    ...
    setTimeout(() => {label.prepend(createSVG()); checkbox.style.backgroundColor= '#19213f'; label.appendChild(checkbox);const checkboxes = label.querySelector('.checkbox'); checkboxes[0].remove()}, 1000)
...
return
  ...
  document.querySelector('.requests').appendChild(newLabel)
