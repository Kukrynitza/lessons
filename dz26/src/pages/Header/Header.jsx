  ...
  return (
    <header className={styles.header} style={{ '--gradient': gradient }}>
      <ul className={styles.catalog}>
        ...
        <li><NavLink to="/categories/edit" className={({ isActive }) => (isActive ? styles.aActive : styles.a)} style={{ '--textcolor': pages[currentIndex].textColor }} end>UpdateCategory</NavLink></li>
      </ul>
    </header>
  )
}
